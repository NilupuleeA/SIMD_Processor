...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "INSTR_BRAM_DEPTH" -parent ${Page_0}
...
proc update_PARAM_VALUE.INSTR_BRAM_DEPTH { PARAM_VALUE.INSTR_BRAM_DEPTH } {
	# Procedure called to update INSTR_BRAM_DEPTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.INSTR_BRAM_DEPTH { PARAM_VALUE.INSTR_BRAM_DEPTH } {
	# Procedure called to validate INSTR_BRAM_DEPTH
	return true
}
...
proc update_MODELPARAM_VALUE.INSTR_BRAM_DEPTH { MODELPARAM_VALUE.INSTR_BRAM_DEPTH PARAM_VALUE.INSTR_BRAM_DEPTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.INSTR_BRAM_DEPTH}] ${MODELPARAM_VALUE.INSTR_BRAM_DEPTH}
}
