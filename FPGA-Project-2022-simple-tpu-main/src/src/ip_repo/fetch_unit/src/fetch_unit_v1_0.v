	...
	(
		...
		output [BRAM_DEPTH-1:0] output_addr,
		output output_clk,
...
// Instantiation of Axi Bus Interface S00_AXIS
	...
	assign input_clk = s00_axis_aclk;
	assign input_we = 1'b1;
	assign kernel_clk = s00_axis_aclk;
	assign kernel_we = 1'b1;
	assign instr_clk = s00_axis_aclk;
	assign instr_we = 1'b1;
	assign output_clk = m00_axis_aclk;
